...
function ClassDetail({ id }) {
    ...
    useEffect(() => {
        const singgleData = async () => {
            try {
                ...
                setGambar(response.data.gambar_kelas);
                setHarga(response.data.harga_kelas);
                setDeskripsi(response.data.deskripsi_kelas);
                setData("nama_kelas", response.data.nama_kelas);
            } catch (error) {
    ...
    return (
        <div className="pattern-1">
            {openCreateClass && (
                <PopOver>
                    <div className="pattern-1">
                        ...
                        <form
                            onSubmit={submit}
                            className="bg-white flex flex-col gap-5 w-96 pattern-1"
            ...
            <div
                className="mx-5 md:mx-32 mt-10  md:-mt-10 cursor-pointer md:mb-20"
